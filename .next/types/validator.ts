...
// Validate ../../app/api/saved-codes/[id]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/saved-codes/[id]">> = Specific
  const handler = {} as typeof import("../../app/api/saved-codes/[id]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../app/api/saved-codes/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/saved-codes">> = Specific
  const handler = {} as typeof import("../../app/api/saved-codes/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
