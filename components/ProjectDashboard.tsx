...
type Project = { id: string; title: string; code: string; createdAt: string; updatedAt: string };
  ...
  return (
    <main className="dashboard-shell">
      ...
      <section className="dashboard-header">
        <div><p className="eyebrow">Kasim Saifi · Your workspace</p><h1>My C projects</h1><p className="subtle">Keep every experiment, assignment, and practice program in one place.</p></div>
        <Link href="/editor/new" className="primary-button">＋ New project</Link>
      </section>
      {projects.length === 0 ? (
        <section className="empty-card"><div className="empty-icon">⌘</div><h2>Start your first project</h2><p>Create a C program, run it against stdin, and it will appear here automatically.</p><Link href="/editor/new" className="secondary-button">Open the editor</Link></section>
      ) : (
